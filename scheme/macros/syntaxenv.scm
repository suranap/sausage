...
(define standard-syntactic-environment
  '((quote         . (special quote))
    ...
    (case-lambda   . (special case-lambda))
    (if            . (special if))
    (set!          . (special set!))
    (begin         . (special begin))
...
(define denotation-of-let
  (syntactic-lookup standard-syntactic-environment 'let))

(define denotation-of-letrec
  (syntactic-lookup standard-syntactic-environment 'letrec))

(define denotation-of-case-lambda
  (syntactic-lookup standard-syntactic-environment 'case-lambda))
...
(define denotation-of-defmacro
  (syntactic-lookup standard-syntactic-environment 'defmacro))
